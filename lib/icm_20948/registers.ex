defmodule Icm20948.Registers do
  ...
  #   // Break
   defmacro agb0_reg_accel_xout_h(), do: 0x2d
  #  defmacro agb0_reg_accel_xout_l(), do: ,
  #  defmacro agb0_reg_accel_yout_h(), do: ,
  #  defmacro agb0_reg_accel_yout_l(), do: ,
  # defmacro  agb0_reg_accel_zout_h(), do: ,
  #  defmacro agb0_reg_accel_zout_l(), do: ,
  # defmacro  agb0_reg_gyro_xout_h(), do: ,
#  defmacro   agb0_reg_gyro_xout_l(), do: ,
#   defmacro  agb0_reg_gyro_yout_h(), do: ,
#  defmacro   agb0_reg_gyro_yout_l(), do: ,
#  defmacro   agb0_reg_gyro_zout_h,
#    defmacro agb0_reg_gyro_zout_l,
  #   AGB0_REG_TEMP_OUT_H,
  #   AGB0_REG_TEMP_OUT_L,
